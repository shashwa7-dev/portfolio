      ...
      <div className="grid grid-cols-2 -sm:grid-cols-1 gap-2.5">
        {clients.map((client) => (
          <a
            ...
            className="group flex items-center gap-3 px-3 py-2.5 rounded-xl border border-border bg-card/60 transition-[border-color,background-color,transform,box-shadow] duration-200 ease-[--ease-out] hover:bg-card hover:border-border-strong hover:-translate-y-px hover:shadow-sm active:scale-[0.98]"
          >
