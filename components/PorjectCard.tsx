...
export default function ProjectCard({ project }: { project: TProject }) {
  ...
  return (
    <div className="relative flex flex-col  gap-1 cursor-pointer rounded-xl border border-border bg-card transition-transform duration-300 ease-in-out hover:scale-[1.02] overflow-hidden h-[350px] md:h-[325px] group">
      {/* Header */}
