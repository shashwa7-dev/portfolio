  ...
  return (
    ...
    <main data-bare className="py-10 md:py-16">
      <Container width="reading">
        {/* The letter sits on paper, not straight on the video.

            Plain translucent background rather than `backdrop-blur`: the
            backdrop is already blurred in `globals.css`, and over a blurred
            backdrop a translucent surface is indistinguishable from a frosted
