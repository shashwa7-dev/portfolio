...
None of the faces on this page are photographs, AI images, or files sitting on a server. Each one is drawn when the page loads, by a browser following instructions, from nothing but a name.
