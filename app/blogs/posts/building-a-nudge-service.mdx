...
summary: "Our nudges were hardcoded on the frontend, which is fine until it very much is not. My job was to take the whole thing end to end. Here is what a nudge actually is, what broke on the backend, what broke on the frontend, and what I would do next."
---
