...
<img
  ...
  className="my-8 rounded-lg overflow-hidden w-full grayscale transition-[filter] duration-base ease-out hover:grayscale-0"
  priority
/>
...
<img
  ...
  className="rounded-lg overflow-hidden w-full border grayscale transition-[filter] duration-base ease-out hover:grayscale-0"
  priority
/>
